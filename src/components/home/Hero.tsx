...
export function Hero() {
  ...
  const tc = useTranslations("home.credenciales");
  ...
  return (
    <section className="relative flex min-h-[min(92vh,900px)] items-center overflow-hidden px-0 pb-[100px] pt-20">
      ...
      <div className="shell relative w-full">
        ...
        >
          {CREDENTIALS.map((clave, i) => (
            <span key={clave} className="flex items-center gap-[18px]">
              {tc(clave)}
      ...
      <div className="absolute bottom-[26px] left-1/2 flex -translate-x-1/2 flex-col items-center gap-2.5">
        <span className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted">{t("scroll")}</span>
